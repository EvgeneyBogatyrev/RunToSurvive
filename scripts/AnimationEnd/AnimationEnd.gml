/// [club71159649|@description] animation_end(sprite_index,image_index, rate)
/// [id153965260|@param] {real} <sprite_index> The index of the sprite being animated
/// [id153965260|@param] {real} <image_index> The current frame value
/// [id153965260|@param] {real} <rate> -See Below-
