///@desc Draw Nine Slice Box
///@param sprite
///@param x1
///@param y1
///@param x2
///@param y2
function DrawNineSlice(argument0, argument1, argument2, argument3, argument4) {
	...
	for (var i = 0; i < _columns; ++i)
	{
		...
		//bottom edge
		draw_sprite_part(_sprite, 0, _size * 2, _size, _size, _size, _x1 + i * _size, _y1 + _rows * _size);
	}
